                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('uploads/rooms/'.$row->featured_photo)}}" alt="" class="w_200">
                                    </td>
                                    <td>{{$row->name}}</td>
                                    <td>{{$row->price}}</td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Total Amenities</label>
                                                    </div>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="iframe-container1">
                                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/{{$row->video_id}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                                                            </iframe>
                                                        </div>
                                                    </div>
                                                </div>
