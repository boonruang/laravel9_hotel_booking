...
<div class="slider">
    <div class="slide-carousel owl-carousel">
        ...
        <div class="item" style="background-image:url({{asset('uploads/slides/'.$item->photo)}});">
            <div class="bg"></div>
            <div class="text">
                <h2>{{$item->heading}}</h2>
                <p>
...
<div class="home-rooms">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="main-header">{{$global_page_data->room_heading}}</h2>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="inner">
                    <div class="photo">
                        <img src="{{asset('uploads/rooms/'.$item->featured_photo)}}" alt="">
                    </div>
                    <div class="text">
