        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-12 left">
                ...
                <div class="room-detail-carousel owl-carousel">
                    ...
                    <div class="item" style="background-image:url({{asset('uploads/rooms/'.$item->photo)}});">
                        <div class="bg"></div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="amenity">
                    ...
                    <div class="row">
                        @foreach ($amenities as $item)
                            @if (in_array($item->id,$arr_amenities))
                            <div class="col-lg-6 col-md-12">
                                <div class="item"><i class="fa fa-check-circle"></i> {{$item->name}}</div>
                            </div>
                            @endif
                        @endforeach
                    </div>
